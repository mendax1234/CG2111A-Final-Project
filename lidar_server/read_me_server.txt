These are the files used for SLAM mapping and TLS server setup.
Note that all libraries other than networking has been deleted to prevent bloat. 
...
Server key, cert, csr and signing perm goes into SlamLab -> nodes, TLS_node_data.
