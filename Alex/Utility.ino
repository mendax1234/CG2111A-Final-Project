...
unsigned long computeDeltaTicks(float ang) {
  ...
  // wheel revolution. This is (probably) incorrect but simplifies calculation.
  // # of wheels revs to make one full 360 turn is alexCirc / WHEEL_CIRC
  // This is for 360 degrees. For ang degrees it will be (ang * alexCirc) / (360
  // * WHELL_CIRC) To convert to ticks, we multiply by COUNTS_PER_REV.
